...
const razorpay = new Razorpay({
  key_id: 'rzp_live_7RUhyfbCMflvJl',
  key_secret : 'CERzi8sfiMOcMApDiuLsP4ML'
})
...
// app.get("/update/grades", function(req, res) {
...
//               User.findOneAndUpdate({ key: key }, { remarks : "FIRST PRIZE WINNER"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
...
//               User.findOneAndUpdate({ key: key }, { remarks : "SECOND PRIZE WINNER"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
//                   console.log("remarks updated!!");
...
//               User.findOneAndUpdate({ key: key }, { remarks : "THIRD PRIZE WINNER"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
//                   console.log("remarks updated!!");
...
//               User.findOneAndUpdate({ key: key }, { remarks : "CONSOLATION PRIZE WINNER"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
//                   console.log("remarks updated!!");
...
//               User.findOneAndUpdate({ key: key }, { remarks : "OUTSTANDING ENTRY"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
//                   console.log("remarks updated!!");
...
//               User.findOneAndUpdate({ key: key }, { remarks : "PRAISEWORTHY ENTRY"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
//                   console.log("remarks updated!!");
...
//             }
//             else if(grade == 0){
//               User.findOneAndUpdate({  key: key }, { remarks : "NO GRADES YET"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
//                   console.log("remarks updated!!");
...
//             }
//             else{
//               User.findOneAndUpdate({ key: key }, { remarks : "GOOD ENTRY"} , (err, update) => {
//                 if (err) {
//                   console.log(err);
//                 } else {
//                   console.log("remarks updated!!");
...
app.post("/admin/grading/:routeKey/asdfghjkl", function(req, res){
  console.log("the grade given is " + req.body.grade);

  var grade = req.body.grade;


  if(grade < 100  && grade >= 95){
    User.findOneAndUpdate({ key: req.params.routeKey }, { remarks : "FIRST PRIZE WINNER"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
    ...
    User.findOneAndUpdate({ key: req.params.routeKey }, { remarks : "SECOND PRIZE WINNER"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
    ...
    User.findOneAndUpdate({ key: req.params.routeKey }, { remarks : "THIRD PRIZE WINNER"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
    ...
    User.findOneAndUpdate({ key: req.params.routeKey }, { remarks : "CONSOLATION PRIZE WINNER"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
    ...
    User.findOneAndUpdate({ key: req.params.routeKey }, { remarks : "OUTSTANDING ENTRY"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
    ...
    User.findOneAndUpdate({ key: req.params.routeKey }, { remarks : "PRAISEWORTHY ENTRY"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
    ...
    User.findOneAndUpdate({ email: email }, { remarks : "NO ENTRY"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
    ...
    User.findOneAndUpdate({ email: email }, { remarks : "GOOD ENTRY"} , (err, update) => {
      if (err) {
        console.log(err);
      } else {
        console.log("remarks updated!!");
...
// app.get("/delete/extra", function(req, res){
//   //6398
//
//
//   User.deleteMany({ essay : "", paymentMade : false}).then(function(){
...
app.post("/findresult/student", function(req, res){
  User.find({email : req.body.email }, function(err, data){
     if(data){
         var finaldata = [];
          for(var i = 0; i<data.length; i++){
              if(data[i].paymentMade == true){
                finaldata.push(data[i]);
              }
          }
          console.log("length of finaldata array is " + finaldata.length);
          console.log("The length of entries from this email is/are : " + data.length);
          if(finaldata.length != 0){
            res.render("find-result", {data : finaldata, length:finaldata.length });
          }
          else{
            res.render("find-result", {data : null, length: 0});
          }
     }
     else{
       res.send("NO SUCH DATA FOUND");
